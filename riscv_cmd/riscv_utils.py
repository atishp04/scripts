...
class const(object):
	...
	PATH_STRING_BL_IMAGE = "/home/atish/workspace/opensbi/build/platform/sifive/fu540/firmware/fw_payload.bin"
	PATH_STRING_FSBL_IMAGE = "/home/atish/workspace/freedom-u540-c000-bootloader/fsbl.bin"
	PATH_STRING_BL_PART_SDCARD = "/dev/sdb1"
	...
	CMD_BL_COPY = "scp " + USERNAME_BUILD_SERVER + "@" + PATH_STRING_BUILD_SERVER + ":" +PATH_STRING_BL_IMAGE + " /tmp/bl.bin"
